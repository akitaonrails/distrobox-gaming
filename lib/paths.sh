...
: "${DG_SHADPS4_QTLAUNCHER_RELEASE:=2026-04-09-30ad647}"
...
export DG_SHADPS4_QTLAUNCHER_ROOT DG_SHADPS4_QTLAUNCHER_RELEASE DG_SHADPS4_QTLAUNCHER_BIN
export DG_SHADPS4_VERSIONS_ROOT DG_SHADPS4_CHANNEL DG_SHADPS4_MANAGED_BIN DG_SHADPS4_BIN DG_SHADPS4_CMD_ALIAS
