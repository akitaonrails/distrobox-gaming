...
- **Native recomp / decomp / source ports**: Ship of Harkinian (OoT), 2Ship2Harkinian (Majora's Mask), Starship (Star Fox 64), Render96ex (SM64), SpaghettiKart (MK64), Sonic P-06, Unleashed Recomp, PrBoom-Plus Doom II RT, DUDE (Doom 3, `docs/dude.md`), GoldenEye 007 Recompiled (`docs/goldeneye-recomp.md`), and SymphonyRecomp (Castlevania: SotN, `install_sotn_recomp`, `docs/sotn-recomp.md`).
