...
- **Native recomp / decomp / source ports**: Ship of Harkinian (OoT), 2Ship2Harkinian (Majora's Mask), Starship (Star Fox 64), Render96ex (SM64), SpaghettiKart (MK64), Sonic P-06, Unleashed Recomp, PrBoom-Plus Doom II RT, DUDE (Doom 3, `docs/dude.md`), GoldenEye 007 Recompiled (`docs/goldeneye-recomp.md`), and Donkey Kong 64 Recompiled (prebuilt N64Recomp+RT64 release; `install_dk64_recomp`, `docs/dk64-recomp.md`).
